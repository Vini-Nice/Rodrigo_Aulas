    ...
    const perguntas = [
        {
            ...
            choices: [
                {name: chalk.bgCyanBright('Listar Contatos'), value: 'listar'},
                {name: chalk.bgCyanBright('Exibir detalhes do contato'), value: 'exibir'},
                {name: chalk.bgCyanBright('Criar Contato'), value: 'criar'},
                {name: chalk.bgCyanBright('Atualizar Contato'), value: 'atualizar'},
                {name: chalk.bgCyanBright('Remover Contato'), value: 'remover'},
